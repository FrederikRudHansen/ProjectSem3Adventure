...
function generateTimeSlots() {
  ...
  const bookings = JSON.parse(localStorage.getItem('gokartindeBookings')) || [];
...
confirmButton.addEventListener('click', () => {
  ...
  let bookings = JSON.parse(localStorage.getItem('gokartindeBookings')) || [];
  const newBooking = {
    date: selectedDate,
    time: selectedTime,
  ...
  localStorage.setItem('gokartindeBookings', JSON.stringify(bookings));
...
function displaySortedBookings() {
  ...
  let savedBookings = JSON.parse(localStorage.getItem('gokartindeBookings')) || [];

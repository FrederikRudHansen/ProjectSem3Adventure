...
function generateTimeSlots() {
  ...
  const bookings = JSON.parse(localStorage.getItem('sumoBookings')) || [];
...
confirmButton.addEventListener('click', () => {
  ...
  let bookings = JSON.parse(localStorage.getItem('sumoBookings')) || [];
  const newBooking = {
    date: selectedDate,
    time: selectedTime,
  ...
  localStorage.setItem('sumoBookings', JSON.stringify(bookings));
...
function displaySortedBookings() {
  ...
  let savedBookings = JSON.parse(localStorage.getItem('sumoBookings')) || [];

...
confirmButton.addEventListener('click', () => {
  ...
  let bookings = JSON.parse(localStorage.getItem('paintudeBookings')) || [];
  const newBooking = {
    date: selectedDate,
    time: selectedTime,
  ...
  localStorage.setItem('paintudeBookings', JSON.stringify(bookings));
...
function displaySortedBookings() {
  ...
  let savedBookings = JSON.parse(localStorage.getItem('paintudeBookings')) || [];

...
function generateTimeSlots() {
  ...
  const bookings = JSON.parse(localStorage.getItem('minigolfudeBookings')) || [];
...
confirmButton.addEventListener('click', () => {
  ...
  let bookings = JSON.parse(localStorage.getItem('minigolfudeBookings')) || [];
  const newBooking = {
    date: selectedDate,
    time: selectedTime,
  ...
  localStorage.setItem('minigolfudeBookings', JSON.stringify(bookings));
...
function displaySortedBookings() {
  ...
  let savedBookings = JSON.parse(localStorage.getItem('minigolfudeBookings')) || [];
